...
class Gaussian(Prior):
    ...
    def __repr__(self):
        ...
        ).format(self.param, self.mu, self.sigma)
        print(message)
...
class Jeffreys(Prior):
    ...
    def __repr__(self):
        ...
        """
        message = (
            "Jeffreys prior on the paramter {}, with minimum and maximum values of x = ({}, {})"
        ).format(self.param, self.minval, self.maxval)
        print(message)
...
class Modified_Jeffreys(Prior):
    ...
    def __repr__(self):
        ...
        """
        message = (
            "Modified Jeffreys prior on the paramter {}, with minimum and maximum values of x = ({}, {}) and knee = {}"
